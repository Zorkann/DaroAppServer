...
export class newMig31579120865571 implements MigrationInterface {
    name = 'newMig31579120865571'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "table" ("id" SERIAL NOT NULL, "number" integer NOT NULL, "slots" integer NOT NULL, "hallId" integer, CONSTRAINT "REL_d900ed59a2f36d8d6f8e484a9e" UNIQUE ("hallId"), CONSTRAINT "PK_28914b55c485fc2d7a101b1b2a4" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "guest_list" ADD CONSTRAINT "FK_d7709be221e7c59e349d9c76758" FOREIGN KEY ("guestId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "table" ADD CONSTRAINT "FK_d900ed59a2f36d8d6f8e484a9e7" FOREIGN KEY ("hallId") REFERENCES "hall"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "reservation" ADD CONSTRAINT "FK_005fbe8bc326fced13b5751aeb3" FOREIGN KEY ("guestId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "table" DROP CONSTRAINT "FK_d900ed59a2f36d8d6f8e484a9e7"`, undefined);
